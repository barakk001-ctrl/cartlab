...
const STRINGS = {
  en: {
    ...
    export_explain: 'Adds every unbought item as a native reminder, filed into a Reminders list named like this list — they sync across devices and can show on the lock screen.',
    ...
    export_step6: 'In the Reminders app, create a list with this list\'s name once (tap "Add List") — the items are filed there.',
  ...
  he: {
    ...
    export_explain: 'מוסיף כל פריט שטרם נקנה כתזכורת, בתוך רשימה בתזכורות עם השם של הרשימה הזו — הן מסתנכרנות בין מכשירים ויכולות להופיע במסך הנעילה.',
    ...
    export_step6: 'באפליקציית התזכורות, צרו פעם אחת רשימה עם השם של הרשימה הזו (לחצו "הוסף רשימה") — הפריטים יתויקו שם.',
